...
```{r fig.cap='Artificial signals, mixtures, and separated signals in figure columns. Order, signs, and PVE of separated signals may change between identical runs.'}
par(mfcol=c(2, 3))
for (i in 1:ncol(S)){
